...
in
{
  programs.helix.languages = {
    ...
    language-server = {
      ...
      debugger = {
        command = getExe' pkgs.lldb_18 "lldb-dap";
        transport = "stdio";
        ...
        templates = [
          {
            ...
            args = {
              ...
              initCommands =
                let
                  lldb_vscode_rustc_primer =
                    pkgs.writeText "lldb_vscode_rustc_primer.py" # python
                      ''
                        import subprocess
                        import pathlib
                        import lldb
                ...
                in
                [
                  "command script import ${lldb_vscode_rustc_primer}"
                ];
            };
          }
        ];
