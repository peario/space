...
{ pkgs ? import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/22.05.tar.gz") {
    overlays = [
      ...
      (import (
        fetchTarball "https://github.com/nix-community/emacs-overlay/archive/88e410d7f1ddef554b40f66755626e5c883487d9.tar.gz"
      ))
      ...
      (_: _: {
        ...
        emacs27-2 =
          (import
            (fetchTarball "https://github.com/NixOS/nixpkgs/archive/4c87cb87a2db6b9eb43541c1cf83f2a2f725fa25.tar.gz")
            { }
          ).emacs;
        emacs28-1 =
          (import
            (fetchTarball "https://github.com/NixOS/nixpkgs/archive/54e795706d9fa90004ed1274af639a717f04a2aa.tar.gz")
            { }
          ).emacs;
        emacs29-1 =
          (import
            (fetchTarball "https://github.com/NixOS/nixpkgs/archive/c434383f2a4866a7c674019b4cdcbfc55db3c4ab.tar.gz")
            { }
          ).emacs29;
      })
    ];
