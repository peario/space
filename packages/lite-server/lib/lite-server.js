 ...
 * applies custom config overrides from user's own local `bs-config.{js|json}`
 * file, and launches browser-sync.
 */
...
module.exports = function start(opts, cb) {
  ...
  function logEnabled() { return config.logLevel !== 'silent'; }
